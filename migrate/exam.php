  ...
  <div class="p-4 flex-1 space-y-6">
    ...
    <div class="bg-white p-8 rounded-[40px] shadow-sm space-y-8 border border-gray-100">
      <form method="POST"><input type="hidden" name="csrf_token" value="<?php echo generate_csrf_token(); ?>">
        ...
        <div class="grid grid-cols-2 gap-4 mt-6"><input type="number" name="quantity" min="1" value="1" class="p-4 bg-gray-50 rounded-2xl font-black text-center" /><div class="p-4 bg-gray-900 rounded-2xl text-opay-green font-black text-xs flex items-center justify-center">SECURE HUB</div></div>
