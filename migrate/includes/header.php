    ...
    <div class="flex min-h-screen">
        ...
        <aside class="w-72 bg-white border-r border-gray-100 hidden lg:flex flex-col fixed h-full z-40">
            ...
            <nav class="flex-1 px-4 py-4 space-y-1 overflow-y-auto scrollbar-hide">
                <?php
                $menuItems = [
                    ['label' => 'Dashboard', 'icon' => 'layout-dashboard', 'path' => '/migrate/dashboard'],
                    ['label' => 'Services', 'icon' => 'grid', 'path' => '/migrate/services'],
                    ['label' => 'Transactions', 'icon' => 'arrow-right-left', 'path' => '/migrate/transactions'],
                    ['label' => 'Rewards', 'icon' => 'coins', 'path' => '/migrate/rewards'],
                    ['label' => 'Virtual Card', 'icon' => 'credit-card', 'path' => '/migrate/vcard'],
                    ['label' => 'Referrals', 'icon' => 'users', 'path' => '/migrate/referrals'],
                    ['label' => 'Support', 'icon' => 'message-square', 'path' => '/migrate/support'],
                    ['label' => 'Profile', 'icon' => 'user', 'path' => '/migrate/profile'],
                ];
