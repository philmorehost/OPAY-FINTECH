...
<div class="max-w-md mx-auto min-h-screen bg-gray-50 flex flex-col pb-24">
    ...
    <div class="p-6 space-y-8">
        ...
        <div class="grid grid-cols-2 gap-4">
            <a href="/migrate/login-settings" class="bg-white p-6 rounded-[32px] border border-gray-100 flex flex-col items-center gap-3 shadow-sm hover:border-billpay-green transition-all">
                <i data-lucide="shield" class="w-6 h-6 text-blue-500"></i>
                <span class="text-[10px] font-black uppercase text-gray-600">Security</span>
            </a>
            <a href="/migrate/logout" class="bg-red-50 p-6 rounded-[32px] border border-red-100 flex flex-col items-center gap-3 shadow-sm hover:bg-red-100 transition-all">
