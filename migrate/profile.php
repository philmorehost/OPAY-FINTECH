...
<div class="max-w-md mx-auto min-h-screen bg-gray-50 flex flex-col pb-10 animate-fade-in">
  ...
  <div class="p-6 space-y-6 pb-24">
    <div class="bg-white p-8 rounded-[40px] shadow-sm flex flex-col items-center border border-gray-100">
      <div class="w-24 h-24 bg-vtu-green/10 rounded-full flex items-center justify-center shadow-lg mb-4"><i data-lucide="user" size="48" class="text-vtu-green"></i></div>
      ...
      <div class="mt-4 flex gap-2"><span class="px-3 py-1 bg-vtu-green/10 text-vtu-green text-[10px] font-black rounded-full">TIER <?php echo h($user['tier']); ?></span><span class="px-3 py-1 bg-gray-100 text-[10px] font-black rounded-full uppercase"><?php echo h($user['kycStatus']); ?></span></div>
    </div>
