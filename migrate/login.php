...
<div class="flex flex-col items-center justify-center min-h-screen px-6 bg-white animate-fade-in">
  <div class="w-full max-w-md">
    ...
    <form method="POST" action="login" class="space-y-6">
      ...
      <div><label class="block text-sm font-medium text-gray-700 mb-1">Username</label><input type="text" name="username" class="w-full p-4 bg-gray-50 text-gray-900 border border-transparent focus:border-vtu-green rounded-xl outline-none" required /></div>
      <div><label class="block text-sm font-medium text-gray-700 mb-1">Password</label><input type="password" name="password" class="w-full p-4 bg-gray-50 text-gray-900 border border-transparent focus:border-vtu-green rounded-xl outline-none" required /></div>
      <button type="submit" class="w-full bg-vtu-green text-white font-bold py-4 rounded-xl shadow-lg">Sign In</button>
    </form>
  </div>
</div>
