...
<body class="flex min-h-screen bg-gray-50 text-gray-900">
    <aside class="w-72 border-r flex flex-col fixed h-full z-40 bg-white border-gray-100 overflow-y-auto scrollbar-hide">
        ...
        <nav class="flex-1 px-4 py-4 space-y-1">
            <?php
            $adminMenu = [
                ['label' => 'Overview', 'icon' => 'layout-dashboard', 'path' => '/migrate/admin/index'],
                ['label' => 'Users', 'icon' => 'users', 'path' => '/migrate/admin/users'],
                ['label' => 'KYC Review', 'icon' => 'shield-check', 'path' => '/migrate/admin/kyc'],
                ['label' => 'Deposits', 'icon' => 'wallet', 'path' => '/migrate/admin/deposits'],
                ['label' => 'All Tx History', 'icon' => 'file-text', 'path' => '/migrate/admin/transactions'],
                ['label' => 'Support', 'icon' => 'message-square', 'path' => '/migrate/admin/support'],
                ['label' => 'Email Hub', 'icon' => 'mail', 'path' => '/migrate/admin/email-hub'],
                ['label' => 'API Hub', 'icon' => 'database', 'path' => '/migrate/admin/api-manager'],
                ['label' => 'Settings', 'icon' => 'settings', 'path' => '/migrate/admin/settings'],
            ];
        ...
        <div class="p-6 border-t border-gray-100">
            <a href="/migrate/logout" class="w-full flex items-center gap-4 px-6 py-4 text-red-500 font-black text-[10px] uppercase tracking-widest hover:bg-red-50 rounded-2xl transition-all">
