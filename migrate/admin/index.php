    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white p-8 rounded-[40px] border border-gray-100 shadow-sm">
            ...
            <div class="grid grid-cols-2 gap-4">
                <a href="/migrate/admin/deposits" class="flex flex-col items-center p-6 bg-gray-50 rounded-3xl hover:bg-billpay-green/10 transition-colors">
                    <i data-lucide="wallet" class="text-purple-500 mb-3 w-6 h-6"></i>
                    <span class="text-[9px] font-black uppercase">Deposits</span>
                </a>
                <a href="/migrate/admin/kyc" class="flex flex-col items-center p-6 bg-gray-50 rounded-3xl hover:bg-billpay-green/10 transition-colors">
                    <i data-lucide="shield-check" class="text-blue-500 mb-3 w-6 h-6"></i>
                    <span class="text-[9px] font-black uppercase">KYC Review</span>
                </a>
                <a href="/migrate/admin/transactions" class="flex flex-col items-center p-6 bg-gray-50 rounded-3xl hover:bg-billpay-green/10 transition-colors">
                    <i data-lucide="file-text" class="text-pink-500 mb-3 w-6 h-6"></i>
                    <span class="text-[9px] font-black uppercase">All Tx</span>
                </a>
                <a href="/migrate/admin/settings" class="flex flex-col items-center p-6 bg-gray-50 rounded-3xl hover:bg-billpay-green/10 transition-colors">
