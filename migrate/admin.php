...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'edit_user') {
        ...
        $stmt = $pdo->prepare("UPDATE settings SET smsRate = ?, kudiSmsToken = ?, siteName = ?, siteDescription = ?, adminWhatsapp = ?");
        $stmt->execute([$_POST['smsRate'], $_POST['kudiSmsToken'], $_POST['siteName'], $_POST['siteDescription'], $_POST['adminWhatsapp']]);
