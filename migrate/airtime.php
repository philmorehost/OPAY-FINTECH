...
<div class="fixed inset-0 bg-black/60 backdrop-blur-md z-[100] flex items-center justify-center p-6">
    <div class="bg-white w-full max-w-sm rounded-[40px] overflow-hidden animate-slide-up shadow-2xl">
        ...
        <div class="p-8 space-y-6 text-center">
            ...
            <a href="/migrate/dashboard" class="block w-full py-5 rounded-[24px] font-black text-sm shadow-xl active:scale-95 transition-all text-white bg-billpay-green uppercase text-center">Done</a>
        </div>
    </div>
</div>
<?php endif; ?>
