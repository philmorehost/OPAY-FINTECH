        ...
        <div class="p-10">
            ...
            <?php elseif ($stage === 4): ?>
                <div class="text-center space-y-6 py-4">
                    ...
                    <div class="pt-6">
                        <a href="/migrate/login" class="block w-full py-5 bg-gray-900 text-white rounded-[24px] font-black uppercase tracking-widest shadow-xl shadow-gray-200">Go to Dashboard</a>
                    </div>
                </div>
            <?php endif; ?>
        </div>
