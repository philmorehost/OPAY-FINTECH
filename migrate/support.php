...
<div class="max-w-md mx-auto min-h-screen bg-gray-50 flex flex-col pb-10 animate-fade-in">
  ...
  <div class="p-4 space-y-6 flex-1"><div class="bg-white p-5 rounded-2xl shadow-sm text-center py-20"><i data-lucide="message-square" class="mx-auto text-gray-200 mb-4" size="48"></i><p class="text-gray-400 font-bold">Need help? Contact support@opayclone.com</p></div></div>
